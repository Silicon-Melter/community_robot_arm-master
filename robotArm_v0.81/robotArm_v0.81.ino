...
void executeCommand(Cmd cmd) {
  ...
  if (cmd.id == 'G') {
    ...
    case 114:  Serial.println("DEBUG: M114 command received");command.cmdGetPosition(interpolator.getPosmm(), interpolator.getPosOffset(), stepperHigher.getPosition(), stepperLower.getPosition(), stepperRotate.getPosition()); Serial.println("DEBUG: M114 command executed");break;// Return the current positions of all axis 
    case 119: {
